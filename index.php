...
<body>
                            ...
                            <li><a href="#">Catalogo</a>
                                <div class="megamenu">
                                    <ul class="single-mega cn-col-4">
                                        <li class="title">Mujeres Collection</li>
                                    ...
                                    <ul class="single-mega cn-col-4">
                                        <li class="title">Hombres Collection</li>
                                        <li><a href="shop.php">T-Shirts</a></li>
    ...
    <!-- ##### Welcome Area Start ##### -->
    <section class="welcome_area bg-img background-overlay" style="background-image: url(img/bg-img/bg-motocross2.jpg);">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="hero-content">
                        ...
                        <a href="#" class="btn essence-btn">Ver ofertas</a>
                    </div>
                </div>
            </div>
        </div>
